...
export function Cta(props: CtaProps) {
  return (
    <section className="px-6 pt-12 pb-24">
      <div className="max-w-7xl px-16 mx-auto bg-gradient-to-r from-primary-800 to-primary-900 mt-8 flex items-center gap-8 justify-between rounded-md h-full">
        <div className="py-8 max-w-2xl flex flex-col gap-4">
          <h2 className="text-slate-50 uppercase font-bold text-4xl">
          ...
          <button className="bg-primary-900 text-slate-50 w-64 rounded-md px-4 py-4 text-lg hover:bg-primary-600 transition-all active:scale-95">
            Download &rarr;
          </button>
        </div>
